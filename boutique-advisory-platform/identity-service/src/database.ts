...
const replicaUrl = process.env.DATABASE_URL_REPLICA || process.env.DATABASE_URL || "postgresql://placeholder:5432/placeholder"
...
export async function connectDatabase() {
  try {
    ...
    // throw error - hardened to allow startup for health checks
